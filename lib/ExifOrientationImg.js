...
var _exif2css = require('./exif2css.js');
  ...
  _createClass(ExifOrientationImg, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          imgProps = _objectWithoutProperties(_props, ['src', 'alt', 'hide', 'style', 'onLoad']);
      ...
      return _react2.default.createElement('img', _extends({
        ...
        src: src,
        alt: alt,
        style: _extends({}, orientation ? snakeToCamelCaseKeys((0, _exif2css2.default)(orientation)) : { visibility: hide ? 'hidden' : 'visible' }, style)
      }, imgProps));
    }
  }]);
